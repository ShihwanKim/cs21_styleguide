...
if (mainVisualEffect == undefined) {
	mainVisualEffect = function (o) {
		...
		var this_s = this;
		this.o =  $.extend({obj:null,contents:".pconti",numctrs:".popup-list li",toggleBtn:true,prevBtn:null,nextBtn:null,stopBtn:null,playBtn:null,isPlay:false,speed:3000,initNum:1,flickEvt:false}, o||{});
...
mainVisualEffect.prototype.init = function () {
	...
	this.$cont.each(function(){
		...
		$("button",$(this)).unbind("focus").bind("focus",function(){
			this_s.setOn(n);
		});
	...
	if(this.seq!=n){
		...
		for (var i=0; i<this.$cont.length; i++){
			if ( (i+1)==n ){
				...
				$(this.$cont[i]).css({"z-index":100,"opaicty":0}).stop().show().animate({opacity:1},500);
			}else{
...
// �˾���
var mpopupzone;
if (mpopupzone == undefined) {
	mpopupzone = function (o) {
		
		var this_s = this;
		this.o =  $.extend({obj:null,contents:".datalist li",numctrs:".popup-wrap li",toggleBtn:true,prevBtn:null,nextBtn:null,stopBtn:null,playBtn:null,isPlay:false,speed:3000,initNum:1,flickEvt:false}, o||{});
...
mpopupzone.prototype.init = function () {
...
mpopupzone.prototype.setCtrlBtns = function () {
	var this_s = this;
	$(this.o.playBtn).bind("click",function(){  this_s.play(); return false; });
	$(this.o.stopBtn).bind("click",function(){  this_s.stop(); return false; });
...
mpopupzone.prototype.setToggleBtns = function () {
	var this_s = this;
	if(this.o.toggleBtn){
		if(this.isPlay) { $(this.o.playBtn).hide();$(this.o.stopBtn).show();} 
		else { $(this.o.playBtn).show();$(this.o.stopBtn).hide();} 
...
mpopupzone.prototype.setOn = function (n) {
	var this_s = this;
	clearTimeout(this.Timer);		
	if (n==undefined)	n = 1 ;
...
mpopupzone.prototype.setNextOn = function () {
	var this_s = this;
	clearTimeout(this.Timer);		
...
mpopupzone.prototype.play = function(){ 	this.isPlay = true;  this.setToggleBtns();  this.setOn(this.seq);}
mpopupzone.prototype.stop = function(){ clearTimeout(this.Timer); 	this.isPlay = false;  this.setToggleBtns();  }
mpopupzone.prototype.goPrev = function(){
	clearTimeout(this.Timer); 
	var nextNum = parseInt(this.seq) - 1;
	if(nextNum<1)	nextNum = this.$cont.length;
	this.setOn(nextNum);
}
mpopupzone.prototype.goNext = function(){
	clearTimeout(this.Timer); 
	var nextNum = parseInt(this.seq) + 1;
